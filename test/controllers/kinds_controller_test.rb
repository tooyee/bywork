...
class KindsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kind" do
    assert_difference('Kind.count') do
      post kinds_url, params: { kind: { casework_id: @kind.casework_id, code: @kind.code, kindtype: @kind.kindtype, name: @kind.name, remarks: @kind.remarks, status: @kind.status } }
    end
  ...
  test "should update kind" do
    patch kind_url(@kind), params: { kind: { casework_id: @kind.casework_id, code: @kind.code, kindtype: @kind.kindtype, name: @kind.name, remarks: @kind.remarks, status: @kind.status } }

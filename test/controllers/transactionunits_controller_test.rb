...
class TransactionunitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transactionunit" do
    assert_difference('Transactionunit.count') do
      post transactionunits_url, params: { transactionunit: { code: @transactionunit.code, name: @transactionunit.name } }
    end
  ...
  test "should update transactionunit" do
    patch transactionunit_url(@transactionunit), params: { transactionunit: { code: @transactionunit.code, name: @transactionunit.name } }

...
class ActiveunitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activeunit" do
    assert_difference('Activeunit.count') do
      post activeunits_url, params: { activeunit: { code: @activeunit.code, name: @activeunit.name } }
    end
  ...
  test "should update activeunit" do
    patch activeunit_url(@activeunit), params: { activeunit: { code: @activeunit.code, name: @activeunit.name } }
